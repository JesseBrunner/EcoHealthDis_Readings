...
But first let me note a few things. First, the Bradford Hill criteria are all about data or evidence. That is, when we think about associations we mean associations between a putative cause and an effect across multiple individuals or places or whatever, or perhaps over multiple time points or trials. A single cause and effect story is just an anecdote^["This one time, in band camp, a friend told a joke about squirrels and Kool-aid came out of my nose!" is different than, "Every middle school cafeteria worker I've talked with, and there are now dozens, has a story about a kid laughing so hard milk came out of their nose!" The first is clearly an anecdote, while the second is _approaching_ data.].   
