...
We can think of life as a series (or symphony) of interlocking chemical reactions, which means that our knowledge of chemistry---reactants, products, rates, etc.---can teach us a few things about ecology. Let's revisit this idea, reviewing the reactants side of things, and then introduce some new things.
...
If we follow Liebig's law of the minimum a short step further, we might note that fertilizers, for instance, might be most effective if they included several of the commonly limiting nutrients. And they might be more effective still if they contained the right _ratios_ of these limiting nutrients. Why is this? Well in a word, stoichiometry.  In more words, chemical reactions use nutrients in particular ratios. For instance, photosynthesis takes six $\ce{CO2}$ molecules and 12 $\ce{HO2}$ molecules, plus some light and fancy enzymes, to make one sugar (4\ce{C6H12O6}$) and some oxygen and water. That is more O's than C's in this particular reaction. Similarly, while amino acids require nitrogen, they have a lot more carbon and oxygen atoms in them. 
...
#| label: fig-whittaker
#| column: margin
#| fig-cap: "A Whittaker biome diagram. Notice what's on the axes that organize the biomes?"
#| fig.alt: "Diagram showing the world's biomes as areas on a graph of average annual temperature on the x-axis and average annual precipitation on the y-axis."
knitr::include_graphics("WhittakerDiagram.jpg",  dpi = 2000)
```
...
Moreover, if you tell me the temperature and precipitation in a place, I can probably tell you what sorts of plants grow there (see @fig-whittaker), and thus what it looks like, what the animals might be like, and so on. These two variables---temperature and moisture---are hugely important for all organisms, but especially plants. 
...
**Resources**      $\hspace{5cm}$ **Conditions**
