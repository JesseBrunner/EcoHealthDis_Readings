...
The real world is heterogeneous and so you might think about the many epidemiological (and other) models that ignore this heterogeneity with disdain. After all, they are _clearly_ missing biological realities. While I agree with this sentiment, I also want to caution you to throw out the baby with the bathwater. Models are not meant to incorporate every aspect of reality; they are simplifications of reality^[Charicatures?] that are (or usually should be) simple enough to understand. And remember, when they fail to capture the main features of a system, like the way an infection spreads, one can learn a lot by figuring out what feature(s) of the real world are needed to fix things. When a standard SIR model and one with a distribution of infectiousness diverge a great deal, that tells you that heterogeneity is important in driving the epidemic. And that, inevitably, leads you to the next question: why?
