---
title: "Making more of oneself: Life as chemical reactions"
date: "`r Sys.Date()`"
format:
  pdf: default
  html: 
...
#| label: fig-xkcd1
#| cap-location: margin
#| fig-cap: "From xkcd.com/2648/ "
#| fig-alt: "XKCD web comic about buying atoms in bulk and assembling them."

knitr::include_graphics("chemicals_2x.png", dpi=300)
```
...
#| label: fig-xkcd2
#| cap-location: margin
#| fig-cap: "From xkcd.com/1490/"
#| fig-alt: "XKCD web comic about someone being able to see the atoms in things."
knitr::include_graphics("atoms_2x.png", dpi=300)
```
