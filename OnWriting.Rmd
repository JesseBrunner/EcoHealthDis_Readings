...
Writing well is not easy^[See, for instance, your own experience or ask pretty much anyone.]. In part that is because putting our ideas down on a page involves thinking; deep, careful, thinking. If our thinking is unclear, so too will be our writing. Writing in classes can also be difficult because we write for so many purposes: to persuade, to elaborate, to fill the page requirement, or the convince the instructor that _I know the answer!_ and its somewhere in this jungle of sentences if only you look carefully^[Word vomit is rarely good writing!]. 
