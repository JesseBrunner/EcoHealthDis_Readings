---
title: "Some advice for scientific writers"
...
>
> --- Shirley MacLaine, Actress, Author, and, in a [previous life in Atlantis, the brother of a 35,000-year-old spirit named Ramtha](https://en.wikipedia.org/wiki/Shirley_MacLaine#Beliefs_and_interests)  


Writing well is not easy^[See, for instance, your own experience or ask pretty much anyone.]. In part that is because putting our ideas down on a page involves thinking; deep, careful, thinking. If our thinking is unclear, so too will be our writing. Moreover, like the above quote (and the [myriad of its predescesors and followers](https://quoteinvestigator.com/2023/01/26/think-read/)) suggest, we often work through our thinking as we write! 

Writing in classes can also be difficult because we write for so many purposes: to persuade, to elaborate, to fill the page requirement, or the convince the instructor that _I know the answer!_ and its somewhere in this jungle of sentences if only you look carefully^[Word vomit is rarely good writing!]. 

So let me be pain about what I am looking for in your writing: I would like you to _clearly, concisely, evaluate evidence around some argument._
...
Sometimes authors will imply mechanisms or assume I know about them. But again, what is blindingly obvious in your head is probably not in mine^[It's sometimes called the [curse of knowledge](https://timharford.com/2021/04/cautionary-tales-the-charge-of-the-light-brigade/).]. I need you to walk me through the logic of the mechanism, hypothesis, methods, or whatever. I promise I will not be offended if you explain even simple things.
...
Good writing builds to something---an argument or point of view, or evaluating an argument or point of view. There needs to be a sense of direction. For our purposes, writing is always, always about evaluating evidence around an argument. It is not just restating details or evidence from sources^[A list is not an argument], but rather telling the reader what these details or evidence _means_ for some assertion or point of view^[This does not work well when someone does their best to remove themselves from equation, for instance using weasel words to avoid committing to a statement.]. Most of the time I'll be providing a set of questions to answer, so your point or argument will be about your answer(s). But this extends to other settings, too. In any case, you will find that clarity and concision become much easier if you know what you think.  
