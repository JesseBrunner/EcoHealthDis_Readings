---
title: "Trade-offs"
subtitle: "You just can't maximize everything"
#date: "`r Sys.Date()`"
...
The strategy of our _Daphnia_, however, is a bit different. We do not assume they are making choices, but rather have more or less fixed strategies^[Although we can also consider "plastic" strategies that respond in predictable ways to different or varying environments. But again, we assume a genetic or epigenetic basis for them as opposed to learning and cognition.] that incorporates all the dimensions of its life history, such as its growth, rate of maturity, longevity, reproductive output, etc. For instance, (early) reproduction comes at the cost of growth---and larger individuals can produce more offspring per clutch---and maintenance---meaning there is a reduced chance of surviving to reproduce in the future.  Thus, reproduction _now_ comes at the cost of _future_ growth and reproduction. So maybe a better strategy would be to grow to a certain size and then start to reproduce like bonker balls.

A species' life history strategy is a genetically determined plan or approach to dealing with all of the trade-offs they face in terms of growth, development, and reproduction.


# There is no single optimum 

Before we get tied in knots thinking about what an optimal _Daphnia_ (or any other critter or student) should do, it is worth noting two things. First, there are many winning strategies! Just look around you! You can probably see very long-lived trees that might take decades before the even begin to reproduce and very short-lived flies that live months and that might reproduce within a matter of days. Or think of you, in between the two. The tree might send out bazillions^[Bigger than a handful, less than a googolplex.] of seeds every year, while even the most ambitious human parent will have several dozen over a lifetime^[The record, according to [Wikipedia](https://en.wikipedia.org/wiki/List_of_people_with_the_most_children) is 69 children to a monogamous couple, although the numbers for male monarchs, religious leaders, and a weird collection of business men, polygamists, and sperm donors are eye-watering!]. They and we and all sorts of other organisms have taken on all sorts of different strategies and the mere fact of their existence^[Remember, if they were sub-par they would be outpaced by those with more fit and fecund strategies. Good old evolution!] suggests that these strategies _work_! 

Second, and relatedly, what is "optimal" depends on context. Are you liable to be eaten by a predator any day now? Well, reproducing sooner than later seems like a good plan. Can you expect to have more resources in the future to take good care of your young and thus ensure their survival? If so, waiting seems like a good bet. In short, only when given something to maximize _and_ a context can we perhaps develop expectations about what should be optimal^[But keep in mind, we often do not know the full context of any living organism, so our expectations are often myopic and likely to be missing something important].   
...
What does this mean for our trade-offs? Simply that a key part of what is optimal depends on how much you already have (or do or whatever). If you are a health department that already invests a great deal in smoking prevention, investing even more may not get you much bang for your buck. Instead, investing in sex education, if you spend only paltry amounts currently, could lead to large gains in QALYs. Similarly, a _Daphnia_ that is already large might not gain much from investing more in growth, but could instead devote those resources to maintenance (increasing survival) or reproduction. Or one that is near the end of its life might not bother with maintenance or growth, because it is probably going to die soon no matter what it tries, but instead invest in reproduction, going out with a bang!^[No, _Daphnia_ do not do that either metaphorically or euphemistically.]

Once you start thinking about trade-offs, you see them everywhere. Here are a few examples:

## Trade-offs in public health

Public health is the medical land of trade-offs. Not that individual medicine doesn't involve trade-offs (name brand or generic?), but when it comes to populations you are always pitting one group's interests against another's. There is no way these people get paid enough!

*   One thing we heard a lot in the COVID-19 pandemic is that the cure might be worse than the disease. While this was often used to denigrate even basic public health interventions, there is an important point that should not get lost in the political back-and-forth. Keeping people home from schools and work has real costs. Kids get a _lot_ out of being at school, from a better education to necessary social interactions to free lunches and other services. Keeping kids home might reduce their risk of getting COVID-19, but it comes at some cost. Sometimes these costs clearly outweigh the benefits, though it can be difficult to know^[I highly recommend [this podcast](https://omny.fm/shows/cautionary-tales-with-tim-harford/a-tsunami-of-misery) on the costs of interventions, like closing trains down until all of the rails were checked for problems after a train crash or moving people out of the danger zone around the Fukushima Daiichi nuclear accident. ]. 
...
*  You can see a similar pattern even in human populations. How do longevity or rates of early childhood mortality relate to family size? Pretty well! Although the mechanisms involved might be indirect (e.g., through economics and education).
*  We can even see viruses and other parasites as facing trade-offs. If a virus replicates very fast it might attain a huge virus population, increasing the host's infectiousness, but that may comes at the cost of a shorter infectious period and thus fewer opportunities to get passed on. Indeed, this is called^[Do evolutionary ecologists like to name their hypotheses? Apparently...] the "trade-off hypothesis" for the evolution of parasite virulence. It is more a lovely hypothesis than empirical reality, but it stems from evolutionary biologists believing there are fundamental trade-offs _everywhere_!